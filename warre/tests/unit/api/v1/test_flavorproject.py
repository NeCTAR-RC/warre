...
class TestFlavorProjectAPI(base.ApiTestCase):
    ...
    def test_list_flavorprojects_filter_project(self):
        ...
        response = self.client.get("/v1/flavorprojects/?project_id=bogus-id")
    ...
    def test_list_flavorprojects_filter_flavor(self):
        ...
        db.session.commit()
        response = self.client.get(
            f"/v1/flavorprojects/?flavor_id={self.flavor.id}"
        )
        ...
        response = self.client.get("/v1/flavorprojects/?flavor_id=bogus")
