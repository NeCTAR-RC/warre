...
from oslo_limit import opts as oslo_limit_opts
...
oslo_limit_opts.register_opts(cfg.CONF)
...
def init(args=[], conf_file="/etc/warre/warre.conf"):
    cfg.CONF(args, project="warre", default_config_files=[conf_file])
