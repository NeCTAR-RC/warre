...
flavor_rules = [
    policy.DocumentedRuleDefault(
        ...
        operations=[{'path': '/v1/flavors/{flavor_id}/',
                     'method': 'GET'},
...
flavorproject_rules = [
    policy.DocumentedRuleDefault(
        ...
        operations=[{'path': '/v1/flavorprojects/{flavor_id}/',
                     'method': 'GET'},
                    {'path': '/v1/flavorprojects/{flavor_id}/',
                     'method': 'HEAD'}]),
    policy.DocumentedRuleDefault(
        name=FLAVORPROJECT_PREFIX % 'list',
        check_str='rule:%s' % ADMIN_OR_READER,
        description='List flavorprojects.',
        operations=[{'path': '/v1/flavorprojects/',
                     'method': 'GET'},
                    {'path': '/v1/flavorprojects/',
                     'method': 'HEAD'}]),
    policy.DocumentedRuleDefault(
...
reservation_rules = [
    policy.DocumentedRuleDefault(
        ...
        operations=[{'path': '/v1/reservations/{reservation_id}/',
                     'method': 'GET'},
    ...
    policy.DocumentedRuleDefault(
        ...
        operations=[{'path': '/v1/reservations/',
                     'method': 'GET'},
